...
export const tools: ToolSpec[] = [{
  ...
  description: 'Check the health of Squire system services and endpoints. Returns status of the squire systemd service, health endpoints, and recent errors. Use this when troubleshooting issues or verifying system status.',
  parameters: {
    type: 'object',
    properties: {
      verbose: {
